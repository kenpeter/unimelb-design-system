...
(function() {
  window.UOMinjectHeader = function() {
    var assethost, bodyclass, defaultlink, footer, header, local, login, main, n, navparent, page, parent, rootlink, sep, sitemap, tools, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
  ...
  window.UOMinjectGlobalNav = function() {
    ...
    UOMGlobalNavState = (function() {
      function UOMGlobalNavState() {
        ...
        this.sitemap = document.querySelector('div[role="sitemap"]');
      ...
      UOMGlobalNavState.prototype.setupEvents = function() {
        ...
        t = this, uomcontent
         */
        var t, trigger, _i, _len, _ref;
        t = this;
        if (document.countSelector('.uomcontent div[role="navigation"]') === 1) {
          this.localnav = document.querySelector('.uomcontent div[role="navigation"]');
          ...
          _ref = this.localnav.querySelectorAll('h2:first-child,a[href^="#"]');
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            trigger = _ref[_i];
            trigger.addEventListener('click', function(e) {
              e.preventDefault();
          ...
          /*
          After clicking the menu on the top right, there is a little side uom menu label on the very right.
          
          toggleClass means remove or add.
          
          global-activ
          .page-inner.global-active {
          ...
          this.trigger.addEventListener('click', function(e) {
            ...
            /*
            global-active vs active
            gloval-active is z-index default, so it is behind.
            active z-index = 10, so it is front.
             */
            t.trigger.addClass('active');
    ...
    if (document.countSelector('.uomcontent div[role="navigation"]') === 1) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
         ...
         *   <div class="inner">........</div>
         *
         *   so group is <a>, then group.parentNode is <li>, then group.parentNode.childNodes
         *   are <a> & <div class="inner">
         */
        ...
        if (elements.length > 1) {
          ...
          <ul>
            <li>
              <a href="#">link 1.1</a> === group
              <div class="inner"> === childgroup
                <span class="back">link 1.1</span> === childgroup.firstChild 
                <ul>
          ...
          childgroup.firstChild.addEventListener('click', function(e) {
            ...
            /*
            <div class="inner hide active"> === this.parentNode
              <span class="back">link 1.1</span> === this 
                <ul>
                  <li><a href="#">link 1.1.1</a></li>
                </ul>
            </div>
          ...
          /*
          Default, only show <a class="parent"> 
          <ul>
            <li>
              <a href="#" class="parent">link 1.1</a> === group
              <div class="inner" class="hide"> === childgroup
                <span class="back">link 1.1</span> === childgroup.firstChild 
                <ul>
                  <li><a href="#">link 1.1.1</a></li>
                </ul>
          ...
          <ul>
            <li> === this.parentNode
              <a href="#" class="parent">link 1.1</a> === this 
              <div class="inner" class="hide active"> === this.parentNode.querySelector('div')
                <span class="back">link 1.1</span>
                <ul>
                  <li><a href="#">link 1.1.1</a></li>
                </ul>
              </div>  
          ...
          /*
            what is class hide?
            .uomcontent [role="navigation"] .inner.hide {
              -ms-transform: translate3d(100%, 0, 0);
              -webkit-transform: translate3d(100%, 0, 0);
              transform: translate3d(100%, 0, 0);
              -webkit-transition: -webkit-transform .3s ease;
          ...
          /*
            what is class acive?
            .uomcontent [role="navigation"].active {
              right: 0;
    ...
    if (!nav) {
      ...
      /*
        <form action="https://search.unimelb.edu.au" method="get"> === this
          <fieldset>
            <input data-required="" placeholder="Search" name="q" type="search" title="Please enter a keyword" aria-label="Search the University">
            <button type="submit" value="Go" class="search-button"><svg role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-search"></use></svg></button>
            </fieldset>
        </form>
      
        this.action === "https://search.unimelb.edu.au"
        this.elements === fieldset, input, button
        this.elements[1] === input
       */
